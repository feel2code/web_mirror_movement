    ...
    return (
        <footer className="bg-hero-background text-foreground py-10">
            <div className="max-w-7xl w-full mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10">
                <div>
                    <Link href="/" className="flex items-center gap-2">
                        <SiWireguard className="min-w-fit w-5 h-5 md:w-7 md:h-7" />
            ...
            <div className="mt-8 md:text-center text-foreground-accent px-6">
                <p>Copyright &copy; {new Date().getFullYear()} {siteDetails.siteName}. Все права защищены.</p>
                <p className="text-sm mt-2 text-gray-500">Made with &hearts; by feel2code</p>
